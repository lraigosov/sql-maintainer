...
CREATE PROCEDURE [dbo].[BestDocAlertas]
	-- Add the parameters for the stored procedure here
	@mensaje VARCHAR(MAX) = '',
	@profile_email VARCHAR(MAX) = 'TestSendEmailCSJ',
	--@email_to VARCHAR(MAX) = 'mpatino06@Hotmail.com;mpatino06.co@hotmail.com',
	@email_to VARCHAR(MAX) = 'jidarran@deaj.ramajudicial.gov.co;soportebestdoc@bextsa.com;luisjr@bextsa.com',
