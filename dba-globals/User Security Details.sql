...
Entradas: Permisos de lectura en catálogos de base de datos.
Salidas: Filas por usuario con rol y permisos por objeto.
Catálogos: sys.database_principals, sys.database_role_members, sys.database_permissions, sys.tables, sys.procedures, sys.views.
