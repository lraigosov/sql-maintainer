/*
Script: Count Indexes by Fragmentation Level per Table
Propósito: Contar índices por tabla con fragmentación media (10<%<=30) y alta (>30) usando dm_db_index_physical_stats.
Entradas: Permisos de lectura; umbral de fragmentación configurable en el WHERE.
Salidas: Conteos por tabla de fragmentación media/alta y total >10%.
DMVs: sys.dm_db_index_physical_stats, sys.indexes, sys.tables, sys.databases.
Seguridad/Impacto: Solo lectura.
Uso: Ejecutar en la base objetivo; ajustar umbrales si aplica.
*/
