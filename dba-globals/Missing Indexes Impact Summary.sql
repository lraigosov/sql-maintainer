...
Entradas: Umbrales @threshold_table_rows y @threshold_table_updates; permisos de lectura.
Salidas: Medida de mejora, script sugerido y métricas de seeks/scans/filas.
DMVs: sys.dm_db_missing_index_groups, sys.dm_db_missing_index_group_stats, sys.dm_db_missing_index_details, sys.partitions, sys.dm_db_index_usage_stats.
Seguridad/Impacto: Solo lectura; validar scripts antes de crear índices.
Uso: Ajustar umbrales a la carga de trabajo; ejecutar por base.
*/
