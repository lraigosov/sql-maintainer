...
Entradas: Umbrales de filas/actualizaciones; permisos de lectura.
Salidas: Lista de scripts CREATE INDEX con medida de mejora y métricas.
DMVs/Catálogos: sys.dm_db_missing_index_* (groups, group_stats, details), sys.dm_db_index_usage_stats, fn_dblog.
Seguridad/Impacto: Solo lectura; validar scripts antes de crear índices. fn_dblog puede requerir privilegios elevados.
Uso: Ejecutar por base; revisar duplicados con precaución y contexto.
*/
