...
Entradas: Permisos de lectura en catálogos/INFORMATION_SCHEMA.
Salidas: Conjuntos separados: tablas, columnas, claves primarias y foráneas.
Catálogos: sys.tables, sys.columns, INFORMATION_SCHEMA.COLUMNS, INFORMATION_SCHEMA.TABLE_CONSTRAINTS, INFORMATION_SCHEMA.KEY_COLUMN_USAGE, INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS.
